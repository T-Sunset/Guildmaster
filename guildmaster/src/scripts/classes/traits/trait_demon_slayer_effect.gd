# NAME.GD
extends Effect
class_name TraitDemonSlayerEffect

# Constructor
func _init():
	super("Demon Slayer", "This hero is +20% more effective per rank in quests tagged 'Demonic'.", true)
