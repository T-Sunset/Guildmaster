# NAME.GD
extends Effect
class_name TraitUndeadSlayerEffect

# Constructor
func _init():
	super("Undead Slayer", "This hero is +20% more effective per rank in quests tagged 'Undead'.", true)
